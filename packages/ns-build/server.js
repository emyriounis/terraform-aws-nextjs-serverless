...
var next_server_1 = require("next/dist/server/next-server");
...
var nextServer = new next_server_1["default"]({
    hostname: 'localhost',
    port: 3000,
    dir: './',
    dev: false,
    conf: __assign({}, required_server_files_json_1.config),
    customServer: true
});
var main = (0, serverless_http_1["default"])(nextServer.getRequestHandler(), {
    binary: ['*/*'],
    provider: 'aws'
});
